...
class page {
	...
	*/
	function first_page($style=''){
	   if($this->nowindex==1){
	   return "<li class='active hidden-phone'><span>".$this->first_page."</span></li>";
	   }
	   return "<li class='hidden-phone'>".$this->_get_link($this->_get_url(1),$this->first_page,$style)."</li>";
	}
	...
	*/
	function last_page($style='lastpage'){
	   if($this->nowindex==$this->totalpage){
	   return "<li class='active hidden-phone'><span>".$this->last_page."</span></li>";
	   }
	   return "<li class='hidden-phone'>".$this->_get_link($this->_get_url($this->totalpage),$this->last_page,$style)."</li>";
	}
	...
	if($i<=$this->totalpage){
	if($i!=$this->nowindex)
		   $return.=$this->_get_text("<li class='hidden-phone'>".$this->_get_link($this->_get_url($i),$i,$style)."</li>");
	else 
		   $return.=$this->_get_text("<li class='active hidden-phone'><span class='".$nowindex_style."'>".$i."</span></li>");
	}else{
	break;
	}
	$return.="\n";
